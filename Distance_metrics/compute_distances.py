...
with open(file_name, "r") as f_in:
    ...
    for line in f_in:
        ...
        dict_doc[parts[1]].append(
            np.loadtxt("{}/{}_vec.txt".format(args.datadir, parts[0]))
        )
...
with open(file_name, "w") as f_out:
    ...
    for idx_g1 in range(len(lst_groups)):
        for idx_g2 in range(idx_g1, len(lst_groups)):
            ...
            vec_dist = obtain_pairwise_distances(
                dict_doc[group1], dict_doc[group2], num_comparisons
            )
